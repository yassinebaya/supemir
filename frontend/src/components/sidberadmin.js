...
const AdministratifSidebar = ({ onLogout }) => {
  ...
  // Navigation items pour administratif (limitée)
  const administratifNavigationItems = [
    {
      path: '/administratif',
      label: 'Dashboard',
      icon: Home
    ...
    {
      path: '/administratif/classes',
      label: 'Classes',
      icon: BookOpen
    },
    {
      path: '/administratif/etudiants',
      label: 'Étudiants',
      icon: Users
    },
    {
      path: '/administratif/presences',
      label: 'Présences',
      icon: ClipboardList
    },
    {
    ...
    <div>
      <style jsx>{`
        ...
        :root {
          ...
          --header-gradient: linear-gradient(135deg, #053396ff 0%, #1037b9ff 100%);
          --logout-color: #dc2626;
          --logout-hover: #b91c1c;
          --logout-bg: #fef2f2;
        }
      ...
      <div className={`sidebar ${isOpen ? 'show' : ''}`}>
        ...
        <nav className="sidebar-nav">
          <div className="nav-section">
            {administratifNavigationItems.map((item) => {
...
export default AdministratifSidebar;