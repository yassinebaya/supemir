...
const NotificationCenter = ({ onNavigate }) => {
  ...
  // Gérer le clic sur une notification (MODIFIÉ - sans redirection pour les absences)
  const handleNotificationClick = (notification) => {
    switch (notification.type) {
      ...
      case 'payment_expiring':
        ...
        break;
      case 'absence_frequent':
        // Ne plus rediriger - juste afficher un message ou ne rien faire
        console.log('Notification d\'absence cliquée:', notification);
        // Optionnel: afficher un message à l'utilisateur
        // alert('Les détails des absences sont disponibles dans les statistiques ci-dessus');
        break;
      case 'event_upcoming':
                ...
                notifications.map((notification) => (
                  <div
                    ...
                    style={{
                      ...
                      // Style spécial pour les notifications d'absence (cursor différent)
                      cursor: notification.type === 'absence_frequent' ? 'default' : 'pointer'
                    }}
                    className="notification-item"
                    title={notification.type === 'absence_frequent' ? 'Notification d\'absence - Voir les statistiques pour plus de détails' : 'Cliquer pour voir les détails'}
                  >
